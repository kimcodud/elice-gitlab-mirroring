      ...
      content: (
        <div>
          <section className="overflow-hidden shadow-2xl md:grid md:grid-cols-3">
            <img alt="Trainer" src={item.image} className="h-32 w-full object-cover" style={{ height: '45vh' }} />
            ...
            <div className="p-4 text-center sm:p-6 md:col-span-2 lg:p-8">
              ...
              <h2 className="mt-6 font-black uppercase">
                <span className="text-4xl font-black sm:text-5xl lg:text-6xl mb-10">{item.name_en}</span>

                <span className="mt-16 block text-sm font-medium" style={{ textAlign: 'left' }}>
                  {introductionText}
                </span>
              </h2>
              ...
              <p className="mt-8 text-xs font-medium uppercase text-gray-400">starRoad</p>
            </div>
          </section>
        </div>
      ),
    ...
    <div>
      <div>
        <div>
          ...
          <img src="/src/assets/main2.webp" className="mainImg" style={{ marginBottom: '10rem' }} />
        </div>
      </div>
          ...
          {destination.map((item, idx) => (
            ...
            >
              ...
              <div className="p-10">
                ...
                <p className="mb-4 text-base text-neutral-600 dark:text-neutral-200">{item.name_ko}</p>
              </div>
            </div>
          ))}
        </div>
